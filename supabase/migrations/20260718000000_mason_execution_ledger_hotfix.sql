-- Hotfix: ensure Mason durable execution ledger table exists in environments
-- where prior migration 20260717000000_mason_execution_ledger.sql was not applied.
-- This migration is additive/idempotent and safe to run multiple times.
