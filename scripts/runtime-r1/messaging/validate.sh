...
TEMPLATE_FILE="$ROOT_DIR/infra/runtime-r1/messaging/main.bicep"
PARAM_DIR="$ROOT_DIR/infra/runtime-r1/messaging/parameters"
...
Performs local Bicep validation for Runtime R1 Epic E2 templates.
