...
TEMPLATE_FILE="$ROOT_DIR/infra/runtime-r1/compute/main.bicep"
PARAM_DIR="$ROOT_DIR/infra/runtime-r1/compute/parameters"
...
Performs local Bicep validation for Runtime R1 Epic E4 templates.
