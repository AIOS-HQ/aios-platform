...
TEMPLATE_FILE="$ROOT_DIR/infra/runtime-r1/observability/main.bicep"
PARAM_DIR="$ROOT_DIR/infra/runtime-r1/observability/parameters"
...
Performs local Bicep validation for Runtime R1 Epic E3 templates.
