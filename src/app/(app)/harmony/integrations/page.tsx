...
export default async function IntegrationCenterPage() {
  ...
  const items: ConnectorView[] = defs.map((def) => {
    ...
    return {
      ...
      classificationLabel: readiness?.classificationLabel ?? "Not installed",
      classificationDescription: readiness?.classificationDescription ?? "This provider is not installed in the current production catalogue.",
