 ...
 * information?" and, if not, ask structured questions instead of guessing. No
 * schema migration: the default store is in-memory; a persistent
 * `clarification_requests` table is a separately-approved migration.
 */
